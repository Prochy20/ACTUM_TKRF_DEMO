<template>
    <div class="grid md:grid-cols-3 gap-x-10 grid-cols-1 gap-y-10 md:gap-y-0">
        <div>
            <h2 class="font-extrabold text-3xl">Tutorials</h2>
            <div class="my-5">
                Easiest way how to get used to work with Kontent.ai is with
                tutorials.
            </div>
            <a
                target="_blank"
                href="https://kontent.ai/learn/tutorials/write-and-collaborate/create-content/introducing-content-items/"
            >
        ...
        <div>
            <h2 class="font-extrabold text-3xl">E-learing</h2>
            <div class="my-5">
                Do you prefer videos over reading? Try the Kontent.ai elearing
                and courses!
            </div>
            <a target="_blank" href="https://kontent.ai/learn/e-learning/">
                <button class="btn btn--primary">
                    Read more
                    <div class="ml-3 bg-transparent">
                        <svg
        ...
        <div>
            <h2 class="font-extrabold text-3xl">Knowledge base</h2>
            <div class="my-5">
                Still curious? Try to find your answers in the Kontent.ai
                knowledge base.
            </div>
            <a target="_blank" href="https://kontent.ai/learn">
                <button class="btn btn--primary">
                    Read more
                    <div class="ml-3 bg-transparent">
                        <svg
        ...
        <!-- <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/jarjAQp6eNM"
